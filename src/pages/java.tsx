...
export default function JavaQuiz() {
  return <QuizPage language="java" emoji="☕" title="JAVA QUESTION" />
}
...
//       ],
//       correctAnswer: 1,
//       explanation: "In Java, you must specify the data type when declaring a variable. 'int x = 10;' is the correct syntax for declaring an integer variable."
//     },
//     {
...
//       ],
//       correctAnswer: 1,
//       explanation: "Java evaluates from left to right. First, 10 + 20 = 30 (numeric addition), then 30 + \"30\" = \"3030\" (string concatenation)."
//     },
//     {
...
//       ],
//       correctAnswer: 2,
//       explanation: "ArrayList allows duplicate elements. Set, HashSet, and TreeSet do not allow duplicates."
//     },
//     {
...
//       ],
//       correctAnswer: 1,
//       explanation: "The default value of a boolean variable in Java is false. Numeric types default to 0, and object references default to null."
//     }
//   ];
...
//             <p className="text-xl text-gray-600 mb-8">Congratulations on completing the Java quiz</p>
...
//                 className="bg-slate-700 text-white px-8 py-3 rounded-xl font-semibold hover:bg-slate-800 transition-all"
//               >
//                 Back to Home
//               </button>
//             </div>
...
//             <div className="w-12 h-12 bg-gradient-to-br from-red-400 to-red-600 rounded-xl flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
//               ☕
//             </div>
//             <div className="flex-1">
//               <h3 className="text-sm font-semibold text-purple-600 mb-2">JAVA QUESTION {currentQuestion + 1}</h3>
...
//             className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-gray-700 bg-white border-2 border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
//           >
...
//               className="flex items-center gap-2 px-8 py-3 rounded-xl font-semibold text-white bg-purple-600 hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg"
//             >
//               Submit Answer
//             </button>
//           ) : (
//             <button
//               onClick={handleNext}
//               className="flex items-center gap-2 px-8 py-3 rounded-xl font-semibold text-white bg-purple-600 hover:bg-purple-700 transition-all shadow-lg"
//             >
