    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <h1 className="text-2xl font-bold text-purple-600">DevSphere</h1>
          <div className="flex items-center gap-4">
            <Link
              to="/login"
              className="px-6 py-2 rounded-lg font-medium text-purple-600 border border-purple-200 hover:bg-purple-300 hover:text-purple-700 hover:border-purple-700 transition"
            >
              Sign In
            </Link>
            <Link
      ...
      {/* Footer */}
      <footer className="mt-auto border-t border-gray-200 bg-white text-center">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div>
            <h4 className="text-xl font-bold text-purple-600">DevSphere</h4>
            <p className="text-sm text-gray-600 mt-3">AI-powered practice quizzes to accelerate your mastery across languages and stacks.</p>
          </div>
        </div>
        <div className="border-t border-gray-200">
          <div className="max-w-4xl mx-auto px-6 py-4 flex flex-col items-center gap-2 text-sm text-gray-600">
